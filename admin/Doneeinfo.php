...
<body>
  ...
  <div class="container">
    ...
    <div class="navbar">
        ...
        <a href="Doneeinfo.php" class="current">Donee</a>
...
$sql = "SELECT  user_id, username,email,address,contact_no,account_no,role FROM userprofile,doneeinfo Where role='Donee' AND userprofile.user_id=doneeinfo.donee_id AND flag='1' order by userprofile.username  LIMIT $start, $perpage";
