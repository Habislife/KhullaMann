...
$message1.="<div class='front-side' style='float: left; margin-left: 10px;'>
...
$message1 .= '</body></html>';
 ...
 $doneemail= new Mail($doneemail,"Donor information",$message1,$headers);
 $message2 = "<html><head>
<style>
html {
  font-size: 17px;
...
$message2.="<div class='front-side' style='float: left; margin-left: 10px;'>
        <div class='color-grid'>
            <div class='black'></div> 
            <div class='red1'></div>
            <div class='red2'></div>
...
$message2.=$doneeaddress."</p>
            ...
            <div class='phoneNo'>
                ...
                <p>phone no.";
                $message2.=$doneephone."</p> <br><br>
 <p> account no.";
 $message2.=$doneeaccount."</p>
            </div>
            <div class='emailId'>
                <svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' viewBox='0 0 467.211 467.211'
                    enable-background='new 0 0 467.211 467.211' width='30px' height='30px'>
